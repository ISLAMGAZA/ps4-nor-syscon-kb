...
4. **المتابعة:** رد على الأسئلة، اطلب تقارير dumps مُجهّلة، شجّع المساهمة في الـcorpus.
...
- كن شفافاً: هذا مشروعك الشخصي (جهد شخصي / قيد التطوير) — لا تدّعِ غير ذلك.
- اربط المصدر (GitHub)؛ لا ترفع الـexe على مواقع خارجية بشكل منفصل، استخدم صفحة الإصدار فقط.
- لا تطلب بيانات حسّاسة؛ فقط تقارير مُجهّلة عبر زر «Submit to corpus» داخل التطبيق.
...
>
> It's a personal project (still in development). Feedback, bug reports and anonymized dumps are very
> welcome. Thanks!
...
> قاعدة قابلة للبحث يساهم فيها الجميع، وتتيح للفنيّين إرسال تقارير دمبات **مُجهّلة** (دون حفظ
...
>
> المشروع جهد شخصي ولا يزال قيد التطوير. ملاحظاتكم وتقارير الأخطاء والدمبات المُجهّلة مرحّب بها جداً.
> شكراً!
